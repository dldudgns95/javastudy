...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    System.out.println("갯수: " + IntStream.range(1, 6).count());
    System.out.println("최댓값: " + IntStream.range(1, 6).max().getAsInt());
    System.out.println("최솟값: " + IntStream.range(1, 6).min().getAsInt());
