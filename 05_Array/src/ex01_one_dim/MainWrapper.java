...
public class MainWrapper {
     ...
     * 3. 인덱스란 배열의 모든 변수를 구분하기 위한 위치정보이다. 0부터 1씩 증가하는 값을 가진다.
     * 4. 기본 용어
     *    1) 배열명 : 모든 변수의 대표 이름
  ...
  public static void ex02() {
    ...
    // 배열에 저장할 변수의 갯수를 앞으로 "배열의 길이"이라고 표현한다.
    int length = 5;
   ...
   * 2. 중괄호({})를 이용해서 초기화하고자 하는 값을 지정할 수 있다.
  ...
  public static void ex05() {
    ...
    System.out.println(day + "일은 " + weeknames[day % 7] + "요일 입니다.");
  }
  ...
  public static void ex07() {
    ...
    // 배열 a의 참조 값을 배열 b로 전할하면, 배열 a와 b는 동일한 메모리 공간을 참조할 수 있다.
    b = a;
