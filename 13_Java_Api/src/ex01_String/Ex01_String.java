...
public class Ex01_String {
  ...
  public static void ex03() {
    ...
    boolean isEqual2 = name2.equals(name3);
  ...
  public static void ex08() {
    ...
    // indexOf(String str, int index) : 인덱스 index로부터 String str을 검색
  ...
  public static void ex09() {
    ...
    int idx1 = statement.lastIndexOf("걱정");
  ...
  public static void ex10() {
    ...
    // contains 메소드
    // 지정된 CharSequence(String, char[] 등)가 포함되면 true 반환, 아니면 false 반환
