...
public class ContactController {
   ...
   * @param map 사용자가 입력한 값<br>
   *            choice == 1 : name, tel, email, address<br>
   *            choice == 2 : contact_no, name, tel, email, address<br>
   *            choice == 3 : contact_no<br>
   *            choice == 4 : null<br>
   *            choice == 5 : contact_no
  ...
  public String request(String choice, Map<String, Object> map) {
    ...
    case "5":
      ...
      if(contactDto == null) message += "검색한 번호의 연락처는 존재하지 않습니다.";
      else message += "조회결과: " + contactDto.toString();
      break;
    }
